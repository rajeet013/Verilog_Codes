...
REM
REM Generated by Vivado on Mon Jan 19 22:07:06 +0600 2026
...
echo "xvlog --incr --relax -prj BIT_comperator_tb_vlog.prj"
call xvlog  --incr --relax -prj BIT_comperator_tb_vlog.prj -log xvlog.log
