...
REM
REM Generated by Vivado on Sat Jan 17 20:56:30 +0600 2026
...
echo "xvlog --incr --relax -prj mux2x1pi_vlog.prj"
call xvlog  --incr --relax -prj mux2x1pi_vlog.prj -log xvlog.log
